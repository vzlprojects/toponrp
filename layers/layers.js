...
var lyr_DGTOrtos2021 = new ol.layer.Tile({
    ...
    lyr_DGTOrtos2021.setVisible(true);
...
lyr_GoogleRoad.setVisible(false);lyr_DGTOrtos2021.setVisible(true);lyr_GoogleSatellite.setVisible(true);lyr_Toponmia.setVisible(true);lyr_NrdePolcia.setVisible(true);lyr_Lugares.setVisible(true);lyr_CAOP.setVisible(true);
