...
var style_Toponmia = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = "";
    size = 0;
    var labelFont = "16.900000000000002px \'Cambria\', sans-serif";
    ...
    var offsetY = 3;
    var placement = 'line';
    if (feature.get("nome_completo") !== null) {
        labelText = String(feature.get("nome_completo"));
    }
